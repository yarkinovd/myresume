...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/yarkinovweb/personal-site.git
   cd personal-site
   ```
...
[MIT](https://github.com/yarkinovweb/personal-site/blob/main/LICENSE)