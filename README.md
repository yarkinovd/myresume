...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/yarkinovd/personal-site.git
   cd personal-site
   ```
...
[MIT](https://github.com/yarkinovd/personal-site/blob/main/LICENSE)